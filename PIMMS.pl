...
pdf(\"$name\.PIMMS.counts.min_cov.$minimum_coverage.inter.insertion.distances.density.plot.pdf\")
d1 <- density(data1)
plot(d1, main=\"Kernal Density $name inter-insertion distance\", lwd = 3, col=rgb(1,0,0,0.4), xlab = \"Inter unique insertion distance (bp)\")
dev.off()
...
pdf(\"$name\.PIMMS.counts.min_cov.$minimum_coverage.unique.insertion.centile.positions.density.plot.pdf\")
d2 <- density(data2)
plot(d2, main=\"Kernal Density $name unique insertion centile positions\", lwd = 3, col=rgb(1,0,0,0.4), xlab = \"Position centile\")
dev.off()
...
par(mfrow=c(2,2))
plot(d3, main=\"Kernal Density $name NRM\", lwd = 3, col=rgb(1,0,0,0.4), xlab = \"NRM\")
plot(d4, main=\"Kernal Density $name NIM\", lwd = 3, col=rgb(1,0,0,0.4), xlab = \"NIM\")
...
system "mv $name\.PIMMS.counts.min_cov.$minimum_coverage.insertion.positions.NIPdiff.pdf $name\.PIMMS.counts.min_cov.$minimum_coverage.insertion.positions.NIPdiff.zoom.pdf $name\.PIMMS.counts.min_cov.$minimum_coverage.insertion.positions.NIPratio.pdf $name\.PIMMS.counts.min_cov.$minimum_coverage.insertion.positions.NIPratio.zoom.pdf $name\.PIMMS.counts.min_cov.$minimum_coverage.insertion.positions.NIindex.Zoom.pdf $name\.PIMMS.counts.min_cov.$minimum_coverage.insertion.positions.NIindex.pdf $name\.PIMMS.counts.min_cov.$minimum_coverage.insertion.positions.depths.pdf $name\.PIMMS.counts.min_cov.$minimum_coverage.summary.plots.pdf $name\.PIMMS.counts.min_cov.$minimum_coverage.inter.insertion.distances.density.plot.pdf $name\.PIMMS.counts.min_cov.$minimum_coverage.unique.insertion.centile.positions.density.plot.pdf Coverage.and.Distribution.Plots\/";
